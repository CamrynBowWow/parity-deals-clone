	...
	return (
		<>
			<section className='min-h-screen bg-[radial-gradient(hsl(0,72%,65%,40%),hsl(24,62%,73%,40%),hsl(var(--background))_60%)] flex items-center justify-center text-center text-balance flex-col gap-8 px-4'>
				<h1 className='text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tighter'>
			...
			<footer className='container pt-16 pb-8 flex flex-col sm:flex-row gap-8 sm:gap-4 md:justify-between justify-around items-start'>
				<Link href='/'>
					<BrandLogo />
				</Link>
