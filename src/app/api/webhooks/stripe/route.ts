...
async function handleCreate(subscription: Stripe.Subscription) {
	const tier = getTierByPriceId(subscription.items.data[0].price.id); // The values is from line_items field and value is price. Can be found in the Stripe server actions file
